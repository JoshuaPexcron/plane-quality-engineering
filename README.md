...
[![tests](https://img.shields.io/badge/tests-33-blue)](docs/test-list.md)
...
> Work in progress. Strategy, API suite, UI suite, accessibility scans and the dashboard are in place. Next: exploratory sessions and the final README.
